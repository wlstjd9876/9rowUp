	...
	<div class="tp-banner">
		<ul>
			...
			<li data-transition="fade" data-slotamount="7"
				...
				<!-- MAIN IMAGE --> <img
				src="${pageContext.request.contextPath}/resources/img/slider/slide3.jpg"
				...
				<div class="tp-caption lfl largeblackbg br-red" data-x="20"
					...
					data-endeasing="Power4.easeIn" style="z-index: 3">상상 속 여행을
					현실로</div> <!-- LAYER NR. 2.0 -->
				<div class="tp-caption lfl medium_bg_darkblue br-green" data-x="20"
					data-y="200" data-speed="1500" data-start="1800"
					data-easing="Power4.easeOut" data-endspeed="300"
					data-endeasing="Power4.easeIn" data-captionhidden="off">이렇게나
					쉬운 여행일정 짜기</div> <!-- LAYER NR. 2.1 -->
				<div class="tp-caption lfl medium_bg_darkblue br-lblue" data-x="20"
					data-y="250" data-speed="1500" data-start="2100"
					data-easing="Power4.easeOut" data-endspeed="500"
					data-endeasing="Power4.easeIn" style="z-index: 3">여행은 3박 4일,
					준비는 13박 14일</div> <!-- LAYER NR. 2.2 -->
				<div class="tp-caption lfl medium_bg_darkblue br-purple" data-x="20"
					data-y="300" data-speed="1500" data-start="2400"
					data-easing="Power4.easeOut" data-endspeed="500"
					data-endeasing="Power4.easeIn" style="z-index: 3">이제 그 준비까지
					즐거워지는 가장 진보한 일정짜기</div> <!-- LAYER NR. 2.3 -->
				<div class="tp-caption lfl medium_bg_darkblue br-orange" data-x="20"
					data-y="350" data-speed="1500" data-start="2700"
					data-easing="Power4.easeOut" data-endspeed="500"
					data-endeasing="Power4.easeIn" style="z-index: 3">트립스 컴 트루와
					함께하세요!</div> <!-- LAYER NR. 3.0 -->
				<div class="tp-caption customin customout" data-x="right"
					...
					<img class="slide-img img-responsive"
						src="${pageContext.request.contextPath}/resources/img/slider/s21.jpg"
						alt="" />
				</div> <!-- LAYER NR. 3.1 -->
				<div class="tp-caption customin customout" data-x="right"
					...
					<img class="slide-img img-responsive"
						src="${pageContext.request.contextPath}/resources/img/slider/s25.jpg"
						alt="" />
				</div> <!-- LAYER NR. 3.2 -->
				<div class="tp-caption customin customout" data-x="right"
					...
					<img class="slide-img img-responsive"
						src="${pageContext.request.contextPath}/resources/img/slider/s23.jpg"
						alt="" />
				</div> <!-- LAYER NR. 3.3 -->
				<div class="tp-caption customin customout" data-x="right"
					...
					<img class="slide-img img-responsive"
						src="${pageContext.request.contextPath}/resources/img/slider/s22.jpg"
						alt="" />
				</div>
			</li>
			<li data-transition="zoomin" data-slotamount="6"
				...
				<!-- MAIN IMAGE --> <img
				src="${pageContext.request.contextPath}/resources/img/slider/transparent.png"
				...
				<div class="tp-caption sfl modern_medium_light" data-x="20"
					...
					data-easing="Power4.easeOut" data-endspeed="500"
					data-endeasing="Power4.easeIn" style="z-index: 3">새로운 여행</div> <!-- LAYER NR. 1.1 -->
				<div class="tp-caption large_bold_grey heading customin customout"
					data-x="10" data-y="125" data-splitin="chars" data-splitout="chars"
					data-elementdelay="0.05" data-start="1500" data-speed="900"
					data-easing="Back.easeOut"
					data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
					data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
					data-endspeed="500" data-endeasing="Power3.easeInOut"
					data-captionhidden="on" style="z-index: 5">Trips Come True</div> 
				<div class="tp-caption customin customout" data-x="right"
					data-y="100"
					...
					<img class="img-responsive"
						src="${pageContext.request.contextPath}/resources/img/slider/tourist_small.png"
						alt="" />
				</div> 
				<div
					...
					data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
					data-speed="1000" data-start="3600" data-easing="Power3.easeInOut"
					data-splitin="lines" data-splitout="lines" data-elementdelay="0.2"
					data-endelementdelay="0.08" data-endspeed="300"
					style="z-index: 10; max-width: 260%; max-height: auto; white-space: pre-wrap;">
					매번 지겨운 여행은 그만!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br> 믿을만한
					길잡이&nbsp;&nbsp;&nbsp; <strong>Trips Come True</strong>
				</div> 
			</li>
			<li data-transition="slidehorizontal" data-slotamount="1"
				...
				<div class="tp-caption lfl" data-x="left" data-y="100"
					...
					<img class="img-responsive"
						src="${pageContext.request.contextPath}/resources/img/slider/travel_diary.png"
						alt="" />
				</div> <!-- LAYERS NR. 2 -->
				<div class="tp-caption lfr large_bold_grey heading white"
					...
					data-endeasing="Linear.easeNone" data-captionhidden="off">Where
					do you travel?</div> <!-- LAYER NR. 3 -->
				<div
				...
				<div
					...
					data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
					data-speed="1000" data-start="2700" data-easing="Power3.easeInOut"
					data-splitin="chars" data-splitout="chars" data-elementdelay="0.08"
					data-endelementdelay="0.08" data-endspeed="500"
					style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;">TRIPS
					COME TRUE</div> <!-- LAYER NR. 5 -->
				<div
					...
					data-customin="x:0;y:50;z:0;rotationX:-120;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 0%;"
					data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
					data-speed="1000" data-start="3500" data-easing="Power3.easeInOut"
					data-splitin="lines" data-splitout="lines" data-elementdelay="0.2"
					data-endelementdelay="0.08" data-endspeed="300"
			...
			<li data-transition="cube" data-slotamount="7" data-masterspeed="600">
				<!-- MAIN IMAGE --> <img
				src="${pageContext.request.contextPath}/resources/img/slider/skyline.png"
				alt="" data-bgfit="cover" data-bgposition="center bottom"
				...
				<div class="tp-caption lfl" data-x="110" data-y="130"
					...
					data-captionhidden="off">
					<img
						src="${pageContext.request.contextPath}/resources/img/slider/family_1.png"
				...
				<div class="col-md-3 col-sm-6">
					<div class="dishes-item-container">
						...
						<div class="img-frame">
							<!-- Image -->
							<img
								src="${pageContext.request.contextPath}/resources/img/dish/봄여행.png"
								class="img-responsive" alt="" />
				...
				<div class="col-md-3 col-sm-6">
					<div class="dishes-item-container">
						...
						<div class="img-frame">
							<!-- Image -->
							<img
								src="${pageContext.request.contextPath}/resources/img/dish/여름여행.jpg"
								class="img-responsive" alt="" />
							<!-- Block for on hover effect to image -->
							<div class="img-frame-hover">
								<!-- Hover Icon -->
				...
				<div class="col-md-3 col-sm-6">
					<div class="dishes-item-container">
						...
						<div class="img-frame">
							<!-- Image -->
							<img
								src="${pageContext.request.contextPath}/resources/img/dish/가을여행.jpg"
								class="img-responsive" alt="" />
							<!-- Block for on hover effect to image -->
							<div class="img-frame-hover">
								<!-- Hover Icon -->
				...
				<div class="col-md-3 col-sm-6">
					<div class="dishes-item-container">
						...
						<div class="img-frame">
							<!-- Image -->
							<img
								src="${pageContext.request.contextPath}/resources/img/dish/겨울여행.jpg"
								class="img-responsive" alt="" />
							<!-- Block for on hover effect to image -->
							<div class="img-frame-hover">
								<!-- Hover Icon -->
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					...
					<div class="showcase-item">
						<!-- Image -->
						<img class="img-responsive"
							src="${pageContext.request.contextPath}/resources/img/germany.jpg"
							alt="" />
						<!-- Heading -->
						<h3>
